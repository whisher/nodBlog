module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        src: {
            ...
            cssModules: {
                app: ['<%= src.src %>/assets/default/css'],
                admin: ['<%= src.src %>/assets/admin/css'],
                login:  ['<%= src.src %>/assets/login/css']
            },
            fontModules: {
                app: ['<%= src.src %>/assets/default/fonts'],
                admin: ['<%= src.src %>/assets/admin/fonts'],
                login:  ['<%= src.src %>/assets/login/fonts']
            }
        },
        watch: {
            js: {
